...
function generateSampleData() {
  const rows = [
    ['TRN-2001', 'Transport', 'Schedule airport pickup\nConfirm driver, pickup time, and passenger phone.', new Date('2026-06-01'), 'CREATED'],
    ['TRN-2002', 'Transport', 'Review fuel reimbursement\nValidate mileage and receipt attachment.', new Date('2026-06-02'), 'IN-PROGRESS'],
    ['TRN-2003', 'Transport', 'Close completed shuttle booking\nTrip was completed and invoice matched.', new Date('2026-06-03'), 'DONE'],
    ['TRN-2004', 'Transport', 'Add missing vehicle inspection\nBackfill checklist for weekly van review.', new Date('2026-06-04'), 'CREATED'],
    ['TRN-2005', 'Transport', 'Confirm delivery route update\nMake pickup and drop-off order consistent.', new Date('2026-06-05'), 'IN-PROGRESS'],
    ['TRN-2006', 'Transport', 'Clean up expired parking passes\nKeep passes for active drivers only.', new Date('2026-06-06'), 'CREATED'],
    ['TRN-2007', 'Transport', 'Document transit delay exception\nInclude approval owner and new arrival time.', new Date('2026-06-07'), 'IN-PROGRESS'],
    ['TRN-2008', 'Transport', 'Verify mobile ticket upload\nTest image and PDF receipts from drivers.', new Date('2026-06-08'), 'DONE'],
  ];
